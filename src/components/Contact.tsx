            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="flex items-center text-gym-dark hover:text-gym-red transition-colors"
                >
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-gym-red ${
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gym-red"
